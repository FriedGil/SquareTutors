<div class="hero min-h-full bg-base-200 rounded-lg">
	<div class="hero-content flex-col lg:flex-row xl:gap-32">
		...
		<div class="text-center max-w-lg">
			<h1 class="text-3xl font-bold">Ace Standardized Tests</h1>
			<p class="py-6">
...
<div class="hero min-h-full bg-base-200 rounded-lg">
	<div class="hero-content flex-col lg:flex-row-reverse xl:gap-32">
		...
		/>
		<div class="text-center max-w-lg">
			<h1 class="text-3xl font-bold">Improve Grades</h1>
			<p class="py-6">
				Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem
				quasi. In deleniti eaque aut repudiandae et a id nisi.
			</p>
...
<div class="hero min-h-full bg-base-200 rounded-lg">
	<div class="hero-content flex-col lg:flex-row xl:gap-32">
		...
		/>
		<div class="text-center max-w-lg">
			<h1 class="text-3xl font-bold">Learn Ahead</h1>
			<p class="py-6">
				Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem
				quasi. In deleniti eaque aut repudiandae et a id nisi.
			</p>
...
<div class="hero min-h-full bg-base-200 rounded-lg">
	<div class="hero-content flex-col lg:flex-row-reverse xl:gap-32">
		...
		/>
		<div class="text-center max-w-lg">
			<h1 class="text-3xl font-bold">Fast Results</h1>
			<p class="py-6">
				Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem
				quasi. In deleniti eaque aut repudiandae et a id nisi.
			</p>
